...
<head>
    ...
    <link rel="icon" href="<?= dirname($_SERVER['SCRIPT_NAME']) === '/' ? '' : dirname($_SERVER['SCRIPT_NAME']) ?>/assets/img/favicon.ico">
    <link rel="stylesheet" href="<?= dirname($_SERVER['SCRIPT_NAME']) === '/' ? '' : dirname($_SERVER['SCRIPT_NAME']) ?>/assets/css/style.css">
